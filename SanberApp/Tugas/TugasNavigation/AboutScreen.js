  ...
  render() {
    ...
    return (
      <View style={styles.container}>
            <Text style={styles.textAbout}> Tentang Saya </Text>
            <View style={styles.logo}>
                <Image source={require('../Tugas13/assets/images/fotoprofil.jpg')} style={styles.fotoProfil}/>
            </View>

            <View style={styles.profil}>
                <Text style={styles.textName}>Taufik Agung Santoso</Text>
                ...
                <View>
                 ...
                 <View style={styles.protofolio}>
                    <View style={styles.daftarPortofolio}>
                        ...
                        <Text style={styles.txtPort1} >@taufikitera </Text>
                    </View>

                    <View style={styles.daftarPortofolio}>
                        <Icon name = "github" size={35} color="#3EC6FF" />
                        <Text style={styles.txtPort1} >@taufik17 </Text>
                    </View>
                 </View>
             </ImageBackground>
            </View>
            ...
            <View>
                <ImageBackground style={styles.backHubungi}>
                    <View >
                        <Text style={styles.textPort} >Hubungi Saya </Text>
                    </View>
                    <View style={styles.kontak}>
                        <Icon name="facebook" size={25}  color="#3EC6FF" />
                        <Text style={{ color:"#003366", fontWeight:"bold", fontSize:16}}>taufikagungsantoso</Text>
                    </View>
                    <View style={styles.kontak}>
